...
async function setupMetaplexDev() {
  ...
  splittedContent[7] = `metaplex set_start_date -d "${startDate || '09 Sep 2021 16:00:00'}" --env mainnet-beta --keypair ~/.config/solana/candyfactory-mainnet.json > ./logs/main/candy-machine-start-date.txt`
