...
select all NFTS permissions as well as Upload permissions for the `Authenticated` role;; otherwise, the `yarn update-creator-all-rows` and `yarn generate-nfts-sources` commands will not work.
